...
class UserReviewsState extends State<UserReviewsPage> {
  ...
  Future<void> _fetchReviews(String userId) async {
      ...
      for (var review in response) {
        ...
        review['is_open'] = isKebabOpen(kebabberResponse['orari_apertura'],);
        ...
        review['rating'] = (review['quality'] + review['price'] + review['quantity'] + review['menu']) / 4;
      }
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: isLoading
          ...
          : reviews.isEmpty
              ? const Center(child: Text('Nessuna recensione ancora'))
              : ListView.builder(
