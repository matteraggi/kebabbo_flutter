...
class MyScenerState extends State<MyScener> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // Wrap the entire Stack of cards in a GestureDetector so the whole carousel can be dragged
    return Transform.translate(
      // Move the whole carousel up by adjusting the y-offset (negative value moves it up)
