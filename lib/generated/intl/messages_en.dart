...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(results) => "10 km (${results} results)";

  static String m1(results) => "1 km (${results} results)";

  static String m2(results) => "200 meters (${results} results)";

  static String m3(results) => "500 meters (${results} results)";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "cerca_un_kebabbaro":
            MessageLookupByLibrary.simpleMessage("Search for a kebab place..."),
        ...
        "consigliaci_un_kebabbaro":
            MessageLookupByLibrary.simpleMessage("Recommend a kebab place"),
        ...
        "failed_to_load_medals":
            MessageLookupByLibrary.simpleMessage("Failed to load medals"),
        "failed_to_load_post_count":
            MessageLookupByLibrary.simpleMessage("Failed to load post count"),
        ...
        "il_kebab_che_ti_raccomandiamo_e":
            MessageLookupByLibrary.simpleMessage("The kebab we recommend is:"),
        "il_testo_non_puo_essere_vuoto":
            MessageLookupByLibrary.simpleMessage("Text cannot be empty"),
        ...
        "kebab_consigliato":
            MessageLookupByLibrary.simpleMessage("Recommended Kebab"),
        "kebab_sconosciuto":
            MessageLookupByLibrary.simpleMessage("Unknown Kebab"),
        "km_distante_da_te":
            MessageLookupByLibrary.simpleMessage("km away from you"),
        ...
        "nessun_utente_seguito":
            MessageLookupByLibrary.simpleMessage("No users followed"),
        "nessun_utente_ti_segue":
            MessageLookupByLibrary.simpleMessage("No users follow you"),
        ...
        "review_updated_successfully":
            MessageLookupByLibrary.simpleMessage("Review updated successfully"),
        "scrivi_un_commento":
            MessageLookupByLibrary.simpleMessage("Write a comment..."),
        "scrivi_un_post":
            MessageLookupByLibrary.simpleMessage("Write a post..."),
        ...
        "testo_non_disponibile":
            MessageLookupByLibrary.simpleMessage("Text not available"),
