...
Future<void> updateProfile(
    BuildContext context, String? username, String? avatarUrl, List<int>? ingredients) async {
  ...
  final updates = {
    ...
    'avatar_url': avatarUrl ?? currentProfile['avatar_url'], // Use current if null
    'ingredients': ingredients ?? currentProfile['ingredients'], // Use current if null
